...
class StartPage(QMainWindow):
    ...
    #     # Custom buttons with icons
    #     #btnHome = QPushButton(self.recolor_icon("assets/home.png", 'white'), " Home")
    #     self.minimizeButton = QPushButton(QIcon(self.recolor_icon("Icons/min.png", "white")), "")
    #     self.maximizeButton = QPushButton(QIcon(self.recolor_icon("Icons/max.png", "white")), "")
    #     self.closeButton = QPushButton(QIcon(self.recolor_icon("Icons/close.png", "white")), "")
    ...
    #             border: none;
    #             background-color: #333;
    #             padding-top: 5px;  /* Adjust top padding to vertically center */
    #         }
    #         QPushButton:hover {
    #             background-color: #444;
    #         }
    ...
    #     self.canvas.setStyleSheet("background-color: #FFF8DC;")
    #     canvasLayout = QVBoxLayout(self.canvas)
    #     # Stretch to push the recentProjectsList down a bit
    #     canvasLayout.addStretch(0)
    #     # Recent Projects List - without a fixed height, so it will expand
    #     self.recentProjectsList = QListWidget()
    #     canvasLayout.addWidget(self.recentProjectsList, 1)  # The '1' here tells the layout to allow this widget to expand
    ...
    #     mainLayout.addWidget(self.canvas, 1)  # Canvas takes the remaining space
    #     mainLayout.setContentsMargins(0, 0, 0, 0)
    #     mainLayout.setSpacing(0)
    ...
    #     self.helpTextLabel = QLabel()
    #     self.helpTextLabel.setStyleSheet("color: black;")  # Style it as needed
    #     self.helpTextLabel.setWordWrap(True)  # Allow text wrapping
